...
export default function DashboardPage() {
  ...
  return <main className="dashboard-page">
    <header className="site-header shell market-header">
      ...
      <nav><Link href="/listings">Browse homes</Link><Link href="/roommates">Roommates</Link><Link href="/viewings">Viewings</Link><Link href="/applications">Applications</Link><Link href="/rental-offers">Offers</Link><Link href="/verification">Verification</Link><Link href="/messages">Messages</Link></nav>
    ...
    <section className="dashboard-shell shell">
      <div className="dashboard-heading">
        ...
        <div className="dashboard-heading-actions"><Link className="button button-ghost" href="/rental-offers">Rental offers</Link><Link className="button button-ghost" href="/applications">Review applicants</Link><Link className="button button-dark" href="/listings/new">Post another place <span>→</span></Link></div>
      </div>
